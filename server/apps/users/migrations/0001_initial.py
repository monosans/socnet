    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_date', models.DateField(blank=True, null=True, validators=[server.apps.users.validators.validate_birth_date], verbose_name='birth date')),
                ('location', models.CharField(blank=True, max_length=128, verbose_name='location')),
                ('image', models.ImageField(blank=True, upload_to=server.apps.users.models.user_image, verbose_name='image')),
