...
chatSocket.onmessage = (e) => {
  ...
  html += `</div><div class="col ms-2"><a href="${data.user_href}">${data.user__username}</a> <span class="text-secondary">${data.date}</span><div class="text-justify text-break me-2">${text}</div></div></div>`;
